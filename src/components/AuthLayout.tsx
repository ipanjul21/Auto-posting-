          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground text-center max-w-sm">
                Kelola dan jadwalkan postingan social media Anda di satu tempat.
                Terintegrasi dengan Facebook, Instagram, TikTok, dan Threads.
              </p>
            </div>
          </div>
          <Button
            ...
            size="lg"
            className="w-full shadow-lg hover:shadow-xl transition-all bg-gradient-to-r from-indigo-500 to-purple-600"
          >
            Sign in to Continue
          </Button>
        </div>
        ...
        {isMobile && (
          <div className="flex border-b h-14 items-center justify-between bg-background/95 px-2 backdrop-blur supports-backdrop-filter:backdrop-blur sticky top-0 z-40">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sm">SocialPost Hub</span>
            </div>
